...
def main():
    ...
    try:
        ...
        # 2. RC Coverage Analysis
        print("\n" + "="*70)
        print("Step 2: RC Curve Coverage Analysis")
        print("="*70)
        ...
        print("\n" + "="*70)
        print("Step 3: Generate Summary Tables")
        print("="*70)
        ...
        print("="*70)
        print("\nGenerated files:")
        print("  - Comprehensive analysis results: results/moe_analysis/cifar100_lt_if100/")
