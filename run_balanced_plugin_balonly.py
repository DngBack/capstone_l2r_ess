#!/usr/bin/env python3
"""
Balanced Plug-in with ONLY BalSoftmax expert (no gating)
=========================================================

- Loads CIFAR-100-LT splits and uses ONLY balsoftmax expert logits
...
- Logits dir: ./outputs/logits/cifar100_lt_if100/balsoftmax_baseline/{split}_logits.pt

Outputs:
- results/ltr_plugin/cifar100_lt_if100/ltr_plugin_balonly_balanced.json
- results/ltr_plugin/cifar100_lt_if100/ltr_rc_curves_balanced_balonly_test.png
"""
...
def main():
    ...
    out_json = Path(CFG.results_dir) / "ltr_plugin_balonly_balanced.json"
    ...
    plot_path = Path(CFG.results_dir) / "ltr_rc_curves_balanced_balonly_test.png"
    ...
    gap_plot_path = Path(CFG.results_dir) / "ltr_tail_minus_head_balonly_test.png"
    plt.figure(figsize=(7, 5))
